...
const projects = [
  {
    ...
    description:
      'Eigen project: duurzame treinreizen door Europa — gebouwd met Laravel, Inertia.js en Vue 3. Van boekingsflow, reisinhoud tot design volledig zelf ontwikkeld.',
