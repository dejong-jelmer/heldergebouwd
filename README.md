...
`npm run build` genereert een volledig statische site in `dist/`. Te hosten op elke statische host (Netlify, Vercel, Cloudflare Pages); `public/_redirects` zorgt voor de SPA-fallback op Netlify.
